...
//                            .orElse(null);
        ...
        {
            //return process with shortest bursttime
            process = Collections.max(processQueue,
                    Comparator.comparingDouble(p-> -p.getBurstTime()));  //negate the bursTime to reverse it
        }

        //need to remove the process from the queue
